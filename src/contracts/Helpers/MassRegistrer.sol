...
contract MassRegistrer  {
    ...
    function massRegistrerERC721Default(address _GBM, address _initiator, address _ERC721Contract, uint256 _tokenIDStart, uint256 _tokenIDEnd) external {
    ...
    //Prerequisite : msg.sender must own the tokenID from _tokenIDStart to _tokenIDEnd and this contract need to be an operator of msg.sender
    function massRegistrerERC721Each(address _GBM, address _initiator, address _ERC721Contract, uint256 _tokenIDStart, uint256 _tokenIDEnd) external {
        while(_tokenIDStart < _tokenIDEnd){
            IERC721(_ERC721Contract).safeTransferFrom(msg.sender, _GBM, _tokenIDStart, "");
    ...
    function massRegistrerERC1155Default(address _GBM, address _initiator, address _ERC1155Contract, uint256 _tokenID, uint256 _indexStart, uint256 _indexEnd) external {
    ...
    function massRegistrerERC1155Each(address _GBM, address _initiator, address _ERC1155Contract, uint256 _tokenID, uint256 _indexStart, uint256 _indexEnd) external {
        GBM(_GBM).registerAnAuctionContract(_ERC1155Contract, _initiator);
